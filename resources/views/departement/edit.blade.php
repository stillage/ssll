@section('title','| Departement - Edit')
        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    ...
                    <!-- Card body -->
                    <div class="card-body">
                        <form method="POST" action="{{ route('departements.update', $departement->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            @include('departement.formEdit')
                        </form>
                    </div>
                </div>
            </div>
